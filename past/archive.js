const crate = [
  {
    ...
    artifacts: [
      ...
      {
        title: "senna",
        description: "greatness is action",
      ...
      {
        title: "weapons",
        description: "used for mass creation",
        source: "GU1DG6U76sl-Bmj3Gsp3sK5wzXKn-X30rb8LkuO-VnQ",
      },
    ],
  },
  {
    ...
    year: "2017",
    description:
      "challenged myself to make an animation only using free and open source software",
    craft: "animation",
    type: "video",
    artifacts: [
      {
      ...
      {
        title: "complete factory",
        description: "the full idea",
  ...
  },
  {
    ...
    year: "2020",
    description:
      "my first time in a professional modern recording studio, improvisation on drum and flute",
    ...
    artifacts: [
      ...
      {
        title: "rec 5",
        description: "reverb, unlocked (flute solo)",
        source: "LStr9j3icr9cka4mfHQHBbKe5-IBDAazCSf6zoNfN-U",
      },
      {
        title: "rec 6",
        description: "a breaking heart (flute solo)",
        source: "2IvMGSjScC1jYmV53H_nvHj8oGA007g8qE-zhOIcKKE",
      },
      {
        title: "rec 7",
        description: "hello from the loop (flute solo)",
  ...
  },
  {
    title: "echo chamber",
    year: "2022",
    description: "skatepark 🤝 instrument",
    ...
    artifacts: [
      ...
      },
      {
        title: "echo 4",
        description: "",
        source: "RxFRhA_X10gfBbQYE2U18ZJEPCqkIXDvChMnhIdDcaob",
      },
      {
        title: "echo 5",
        description: "",
